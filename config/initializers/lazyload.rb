Lazyload::Rails.configure do |config|
  ...
  config.placeholder = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAABCAQAAACx6dw/AAAADUlEQVR42mP88J8BCAAKqQHxlwo57gAAAABJRU5ErkJggg==" # rubocop:disable Metrics/LineLength"
